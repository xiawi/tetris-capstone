	...
	\chapter{Timeline}
		...
		\begin{figure}[h]
			...
			\begin{ganttchart}[
				...
				time slot format = isodate]{2024-04-21}{2024-08-22}
				\gantttitlecalendar{year, month=name}\\
				\ganttgroup{Introduction}{2024-04-21}{2024-04-27}\\
				\ganttbar{Research}{2024-04-21}{2024-04-23}\\
		...
		\section{Writing an Introduction}
			...
			The introduction serves as the project's foundation, providing essential background information, introducing the topic, and articulating the project's objectives. Recognizing its pivotal role, \textbf{one week} of time was allocated for its composition. This deliberate time-frame aimed to allow ample time for thoroughness, ensuring no essential elements were overlooked in writing a comprehensive and compelling introduction.
