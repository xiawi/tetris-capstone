...
\begin{document}
		...
		\section{Problem Statement}
			...
			\begin{figure}
				...
				\begin{minipage}{.4\textwidth}
					...
					\end{tikzpicture}
				\end{minipage}
				\caption{\centering A typical game of Versus Tetris. Both players are trying to send lines to each other. The grey lines are \textit{Garbage Lines} sent from player 2 (right) to player 1 (left).}
	...
	\chapter{Literature Review}
		...
		\section{Optimising Tetris with Nature-inspired Algorithms}
