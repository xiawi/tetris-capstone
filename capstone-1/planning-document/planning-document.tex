...
\begin{document}
	...
	\chapter{Introduction}
		...
		\section{Motivation}
			...
			% Tetris is NP-complete --> There are no optimal solutions 
	 		%						--> The problem is too complex --> Traditional non-heuristic approaches can take more overall resources
	 		%						--> Hence the use of nature-inspired algorithms
	 		% This area of resesarch has been explored before cite papers, but not with the versus tetris variant.
