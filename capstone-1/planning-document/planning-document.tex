...
%				why polynomial > exponential
			...
			\subsection{Understanding the Proof}\label{subsec:understanding-proof}
				...
				\begin{enumerate}
					...
					\item Show that $X \in$ \textit{NP-complete} by reducing a known \textit{NP-hard} problem to $X$.
				\end{enumerate} 
...
%				REDUCTIONS
				...
				With special initial matrices, \citeauthor{tetris-is-hard-even-to-approx} were able to prove that instances of 3-PARTITION can be mapped to instances of the 4 objective functions \cite{tetris-is-hard-even-to-approx}.
