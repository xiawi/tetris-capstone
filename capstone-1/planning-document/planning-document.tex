...
\begin{document}
	...
	\chapter{Literature Review}
		...
		\section{Tetris is NP-complete}
			...
			To better explain NP-completeness, it is paramount to have a solid comprehension of  complexity classes. Thus, the first half of this section will be dedicated to explaining NP-completeness in terms of complexity classes. The second half of this section will delve into the proof that optimally playing Tetris is NP-complete.
			
			\subsection{Complexity Classes}
			% Explain complexity classes in detail
			
			
			\subsection{NP-completeness}
			% Explain what NP-completeness is
			
			% Explain the significance of NP-complete
				% P vs NP
			
			% Explain reductions (cook theorem)
				% What does a reduction necessarily prove?
			
			% Explain the Tetris reduction
			\subsection{The Tetris Reduction}
			
			In their paper, \citeauthor{tetris-is-hard-even-to-approx} defined four natural objectives of Tetris \cite{tetris-is-hard-even-to-approx}:
			
			\begin{enumerate}
				\item maximising the number of rows cleared,
				\item maximising the number of pieces placed,
				\item maximising the number of Tetrises, and
