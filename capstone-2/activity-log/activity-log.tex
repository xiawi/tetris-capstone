	...
	\begin{landscape}
		\begin{figure}
			...
			\begin{ganttchart}[x unit=1cm, vgrid=dotted, hgrid = true]{1}{13}
				...
				\gantttitle{W12}{1}
				\gantttitle{W13}{1}\\
				\ganttgroup{OpenTris}{1}{4}\\
				\ganttgroup{Creating Bot}{4}{11}\\
				\ganttbar{Elementary Bot Behaviour}{4}{6}\\
				\ganttlinkedbar{Evaluation Function}{7}{11}\\
				\ganttbar{Advanced Behaviour}{8}{10}\\
				\ganttgroup{GA Implementation}{11}{13}\\
				\ganttbar{Build GA}{11}{12}\\
				\ganttlinkedbar{Run GA for Data}{13}{13}\\
				\ganttgroup{Report Writing}{11}{13}\\
				\ganttbar{Revise Methodology}{11}{12}\\
				\ganttlinkedbar{Results and Conclusion}{13}{13}
			\end{ganttchart}
